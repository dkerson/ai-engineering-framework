...
|------|---------|---------|------|------|---------|--------|------------|---------------|------------|-------------|---------|
| 2026-07-01 | framework/umbra | Execution Learning Loop + RAG Consumer Hardening | framework-operating-system | Review | FOS, RAG, Knowledge Hub, Product UX | orchestrator, framework-reviewer, rag-evaluator, knowledge-curator | FOS docs, RAG rules/checklists, capability registry, Umbra evidence | execution-learning-loop, RAG canonical identity, golden questions, FOS ledgers/status | rg/git diff | Converted repeated Umbra corrections into reusable rules and Stable Candidate status | Done |
...
| 2026-07-01 | framework | Execution Memory & Evaluation Baseline | framework-operating-system | Review | FOS, Token Economy, QA/Validation | orchestrator | orchestrator, token/context rules, FOS ledgers, COS status | execution-memory, evidence-anchoring, post-mission-evaluation, memory index, FOS docs | rg/git diff | Converts passive ledgers into retrieval, evidence and post-mission learning gates | Done |
| 2026-07-01 | framework | Legacy generator cleanup | framework-operating-system | Standard | FOS, Documentation | orchestrator | tool references, templates, skill-builder | removed tools/generate_framework.py, updated template headers and skill-builder reference | rg/git diff | Removed stale batch generator while preserving Personal-AI path compatibility | Done |
| 2026-07-01 | framework | Execution Target Map Gate | framework-operating-system | Standard | FOS, Token Economy, QA/Validation | orchestrator | gate/banner/model/process/context docs | pre-execution gate, execution banner, model routing, working context, AGENTS, final response | rg/git diff | Approval gate now requires repo/system/database/environment/surface targets before execution | Done |
| 2026-07-01 | framework | Team Telemetry Collector | framework-operating-system | Standard | FOS, Token Economy, Team Operations | orchestrator | FOS ledgers, reports, docs index, AGENTS, prior telemetry plan | collect_execution_metrics, team telemetry docs/rule/template, usage reports, FOS ledgers | collector local run, temp telemetry publish, rg/git diff | Automates team usage reports while keeping prompts/secrets/private data out of telemetry | Done |
