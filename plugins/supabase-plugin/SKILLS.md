...
| Skill | Papel |
|-------|-------|
| supabase-connector | Conexao e health check via MCP |
| supabase-reader | Operacoes read-only |
| supabase-writer | Operacoes write (exige aprovacao) |
